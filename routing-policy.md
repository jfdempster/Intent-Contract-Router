...
The active host decision emits:

```json
{
  "operation_id": "<validated operation id>",
  "routing_policy_version": "2026-06-30.r1-r5",
  "selected_route": "one_shot_distiller | minimum_question_interviewer | existing_prompt_normalizer | contract_auditor",
  "triggering_rule": "R1 | R2 | R3 | R4 | R5",
  "canonical_prompt_path": "<one prompt file>"
}
```
